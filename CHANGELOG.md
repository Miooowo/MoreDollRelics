...
---
## [v0.8-beta 2026-08-06]

### 新增 (Added)
- 新增玩偶遗物「艾冰玩偶」：战斗中攻击额外造成最大生命值 10% 的伤害；战斗结束后有 50% 概率掉落一件食物遗物。已加入玩偶房模组池与中、英文案。

---
## [v0.7-beta 2026-07-15]

### 变更 (Changed)
- 版本号更新为 **v0.7-beta**。
- **狗王玩偶**增强：拾起时失去 3 点生命上限；每 3 场战斗获得 1 点生命上限；你的回合开始恢复 1 点生命并获得 2 点格挡；在敌人回合内受到一次不低于生命上限 20% 的未格挡伤害时，击晕伤害来源敌人，并在下回合开始获得 3 层无实体。
- **王筱巫玩偶**增强：免死触发时回复生命至 7 点，立即获得 999 点格挡，并打出全部卡牌（手牌、抽牌堆、弃牌堆、消耗牌堆）；触发后本场战斗每回合开始获得 99 点格挡（仅生效一次）。
- **娜娜因猫球**削弱：每花费 1 点能量获得的格挡由 4 下调至 2。
